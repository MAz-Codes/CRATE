"""
Generation script for DrumVAE v2 with constrained decoding for musical structure.
"""
...
from model_v2 import DrumVAE, generate_square_subsequent_mask, TOKEN_TYPE_MAP
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate drums with DrumVAE v2")
    parser.add_argument("--model_path", type=str, default="checkpoints_v2/best_model.pt")
    parser.add_argument("--output", type=str, default="samples/generated_v2.mid")
